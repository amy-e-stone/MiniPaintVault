...
{
    // Disable sorting to ensure proper row handling
    ui->paintTableWidget->setSortingEnabled(false);
    ...
    // Clear contents if they exist, before populating the table
    ui->paintTableWidget->clearContents();
...
void MainWindow::on_buttonDisplayShoppingList_clicked()
{
    ...
    // Clear existing rows (refresh if there is a list already displayed)
    ui->paintTableWidget->setRowCount(0);
...
void MainWindow::on_buttonSearch_clicked()
{
    ...
    // Enable sorting to ensure proper row handling
    ui->paintTableWidget->setSortingEnabled(true);
}
